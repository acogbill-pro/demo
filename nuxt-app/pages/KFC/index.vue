...
const imagePath = `../${brandName.value}/images/`
            ...
            <v-row>
                <v-col cols="6">
                    <v-card>
                        ...
                        <v-card-text>
                            <v-img :src="imagePath + 'cSanders.jpeg'" width="300" />
                        </v-card-text>

                        <v-card-actions>
                            <v-btn block to="/wifi" target="_blank" nuxt><v-icon icon="mdi-wifi" block large />Wi-fi Landing
                                Page</v-btn>
                        </v-card-actions>
                    </v-card>
                ...
                <v-col cols="6">
                    <v-card>
                        ...
                        <v-card-text>
                            Simulated TicTuk implementation
                        </v-card-text>

                        <v-card-actions>
                            <v-btn block to="/shop" target="_blank" nuxt><v-icon icon="mdi-cart" block
                                    large />KFC.com.mx</v-btn>
                        </v-card-actions>
                    </v-card>
            ...
            <v-row>
                <v-col cols="6">
                    <v-card>
                        ...
                        <v-card-text>
                            <v-img :src="imagePath + 'products/0010.png'" width="300" />
                        </v-card-text>
                ...
                <v-col cols="6">
                    <v-card>
                        ...
                        <v-card-text>
                            <v-img :src="imagePath + 'products/0005.png'" width="300" />
            ...
            <v-row>
                <v-col>
                    <v-card>
                        ...
                        <v-card-text>
                            <v-img :src="imagePath + 'KFC_SEM.png'" width="300" />
                        </v-card-text>
                        <v-card-actions>
                            <v-btn block
