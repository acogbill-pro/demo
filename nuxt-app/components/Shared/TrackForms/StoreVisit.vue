...
const form = ref(null)
const eventName = ref('Store Visit')
const eventProperties = ref('{"storeId":12345678,"zip_code":12520}')
...
function submitForm() {
    ...
    eventName.value = 'Store Visit'
    eventProperties.value = '{"storeId":12345678,"zip_code":12520}'
