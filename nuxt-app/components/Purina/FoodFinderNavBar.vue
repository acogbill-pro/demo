...
<template>
    <div>
        <v-app-bar id="nav" app color="#E81C24" nuxt>
            <v-toolbar-title>

                <h1>
                    <NuxtLink to="/purina/foodfinder">
                        <v-img src="/purina/images/logo.png" width="200" />
                    </NuxtLink>
                    <!--<NuxtLink to="/">
            ...
            <!--<v-btn color="secondary" text rounded dense :disabled="!undoable" @click="undo">
                                                                                                        <v-icon>mdi-undo-variant</v-icon>
                                                                                                                                                                ...
                                                                                                                                                                <v-spacer />-->
            <v-btn text rounded to="/purina/account" color="white" nuxt icon="mdi-account" />
            <PurinaCartButton />
