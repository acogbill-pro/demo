...
async function loadPhoto() {
    ...
    const generatedPhoto = await profile.fetchPersonalizedImage('Image of the customer and their pets, as identified in traits, running happily in a sunny field.')
