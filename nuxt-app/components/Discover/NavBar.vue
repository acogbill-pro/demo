...
<template>
    <div>
        <v-app-bar id="nav" app color="#E75B18" nuxt>
            <v-toolbar-title>

                <h1>
                    <NuxtLink to="/discover">
                        <v-img src="/discover/images/logo.jpg" width="150" />
                    </NuxtLink>
                    <!--<NuxtLink to="/">
            ...
            <!--<v-btn color="secondary" text rounded dense :disabled="!undoable" @click="undo">
                                                                                                        <v-icon>mdi-undo-variant</v-icon>
                                                                                                                                                                ...
                                                                                                                                                                <v-spacer />-->
            <v-btn text rounded to="/discover/account" color="white" nuxt icon="mdi-account" />
            <!-- <DiscoverCartButton v-if="cart" /> -->
