...
const heroImagePath = computed(() => {
    ...
    return profileTraits.hasTraits ? '/hack25/images/bread.png' : '/hack25/images/grocery.jpg'
})
...
<template v-slot:append>
                        ...
                        <v-btn block to="/hack25/products" nuxt class="ma-0" color="light-blue-lighten-2">Shop
                            Items</v-btn>
...
.hero {
    background: url('../hack25/images/meatBg.jpg');
